...
export const PLUGIN_STYLES = `
      ...
      .tps-gcm-line-capture-modal {
        height: min(var(--tps-gcm-modal-max-height), calc(100vh - 32px));
      }

      .tps-gcm-line-capture-modal .modal-content {
        height: 100%;
        display: flex;
        flex-direction: column;
        min-height: 0;
      ...
      .tps-gcm-line-context-capture-target {
        color: var(--text-muted);
        font-size: var(--font-ui-small);
        overflow: hidden;
        text-overflow: ellipsis;
      ...
      .tps-gcm-line-context-capture-actions {
        display: flex;
        flex-wrap: wrap;
        justify-content: flex-end;
        gap: 8px;
      ...
      .tps-gcm-line-context-capture-actions button {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        gap: 7px;
      ...
      @media (max-width: 600px) {
        ...
        .tps-gcm-line-context-capture-actions button:last-child {
          grid-column: 1 / -1;
        }
      }
